...
// $('#nav-button-label').on('click', function (event) {
    $(document).on('click', '#nav-button-label', function (e) {
        ...
        $("nav").toggleClass("js-close-any");
        if ($("nav").hasClass("js-close-any") == false) {
            $("nav").css('transform', 'translate(0px)');
            $('[off-canvas]').css('transform', 'translate(0px)');
            $('[canvas]').css('transform', 'translate(0px)');
        }
...
// клик на ссылку вызова footer_dropdown
    ...
    function footerDropdown() {
        $(document).off().on('click', '#footer-dropdown', function () {
