...
/**
 * TranslatesSearch represents the model behind the search form of `common\models\Translates`.
 */
class TranslatesSearch extends Translates
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['page', 'text_key', 'text_value', 'lang'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'page', $this->page])
            ->andFilterWhere(['like', 'text_key', $this->text_key])
